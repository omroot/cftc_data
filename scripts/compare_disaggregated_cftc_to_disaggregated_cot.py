...
COT_DB_PATH = REPO_ROOT / "cot_data" / "cot_db.csv"
CFTC_LEGACY_COMBINED_PATH = REPO_ROOT / "cftc_downloads" / "legacy_combined.csv"
CFTC_DISAGG_COMBINED_PATH = REPO_ROOT / "cftc_downloads" / "disaggregated_combined.csv"
OUTPUT_PATH = REPO_ROOT / "cache" / "output" / "cot_db_comparison.csv"
